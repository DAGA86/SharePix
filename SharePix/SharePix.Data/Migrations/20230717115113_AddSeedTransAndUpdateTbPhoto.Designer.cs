...
namespace SharePix.Data.Migrations
{
    ...
    [Migration("20230717115113_AddSeedTransAndUpdateTbPhoto")]
    partial class AddSeedTransAndUpdateTbPhoto
    {
            ...
            modelBuilder.Entity("SharePix.Data.Models.Translation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Key = "createAlbum.name.maxLength",
                            LanguageId = 1,
                            Value = "Maximun 32 characters"
                        },
                        new
                        {
                            Key = "createAlbum.name.minLength",
                            LanguageId = 1,
                            Value = "Minimun 1 character"
                        },
                        new
                        {
                            Key = "createAlbum.description.maxLength",
                            LanguageId = 1,
                            Value = "Maximun 256 characters"
                        },
                        new
                        {
                            Key = "uploadPhoto.location.maxLength",
                            LanguageId = 1,
                            Value = "Maximun 68 characters"
                        },
                        new
                        {
                            Key = "uploadPhoto.description.maxLength",
                            LanguageId = 1,
